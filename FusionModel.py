    ...
    def _init_estimator(self):
        ...
        self.estimator = Estimator(
            backend_options={
                ...
                'noise_model': self.noise_model if self.args.noise else None  # Add noise model when noise is enabled
            },
            run_options={
                'shots': self.shots,
                'seed': self.SEED,
...
class QNet(nn.Module):
    def __init__(self, arguments, design):
        ...
        if arguments.backend == 'tq':
            ...
            print(f"\nRun with Qiskit quantum backend. noise = {arguments.noise} seed = {arguments.qiskit_seed} shots = {arguments.shots}")
